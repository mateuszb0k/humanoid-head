...
The vision system operates as a distributed component that communicates with the NLP module hosted on an NVIDIA Jetson through a REST API. This bidirectional interface ensures that visual telemetry and user identity management are perfectly synchronized across the robot's hardware.
